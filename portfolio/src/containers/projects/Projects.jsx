...
import mvcredit from '../../assets/mvcredit.png';
    ...
    <div className='pf__projects section__padding gradient__bg-2' id='projects'>
      ...
      <Section>
        <div className='pf__projects-container'>
          ...
          <a href='https://fedohun.github.io/vmcredit' target='_blank' className='mgpt-3__anchor'>
              <img src={mvcredit} alt='mvcredit' />            <span></span>
